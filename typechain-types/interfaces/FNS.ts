...
export interface FNSInterface extends utils.Interface {
  functions: {
    ...
    "setSubnodeResolver(bytes32,bytes32,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setSubnodeResolver",
    values: [
      PromiseOrValue<BytesLike>,
      PromiseOrValue<BytesLike>,
      PromiseOrValue<string>
...
export interface FNS extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FNSInterface;
